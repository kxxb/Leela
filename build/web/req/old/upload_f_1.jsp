...
<%
       ...
       String v_session = "";
        ...
        String g_base_url = "";
        String v_item_id = "";
        final String v_request_id = "7651";// request.getParameter("request_id");
        ...
        try {
            g_user_id  = "1"; //session.getAttribute("g_user_id").toString();
        ...
        //out.println(boundary);
            ...
            FileOutputStream fileOut = new FileOutputStream(saveFile);
             ...
             cs = (OracleCallableStatement) conn.prepareCall(
                  ...
                  cs.setStringAtName("p_Request_Id", v_request_id);
...
<html>
    ...
    <body>
        ...
        <form method="GET" enctype="multipart/form-data"  action="upload_f.jsp?request_id=<%=7651%>" >
            <fieldset>
