...
function displayFormComment(){
  ...
  if(!CommentWindow.isVisible()){
     ...
     var  txtRequest_comment = new Ext.form.HtmlEditor({    xtype:'htmleditor',
                        id:'Request_comment',
...
var release_edit = new Ext.form.DateField({
      format: 'd/m/Y'
          ...
          {
                header: 'Номер договора',sortable: true,
