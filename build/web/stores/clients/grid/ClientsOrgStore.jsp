...
<%
    ...
    Connection conn = null;
            String v_sql = "select t.id, t.name from crm_client_s_organization t "+
                            "order by 2";
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    obj.put("ORGANIZATION_ID", my_utils.nvl(rs.getString(1), "пусто"));
                    obj.put("ORGANIZATION_NAME", my_utils.nvl(rs.getString(2), "пусто"));
