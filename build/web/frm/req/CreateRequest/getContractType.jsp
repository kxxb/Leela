...
<%
  ...
  try{
        ...
        int g_user_id = Lela_core.get_users_by_ip(conn, request.getRemoteAddr());
          String v_menu_sql =   " select * from tl_contract_template t  "+
                               " where t.id in ( select t.tl_contr_id from tl_contract_tpl_docs t   " +
         ...
         while (rs.next()){
               ...
               obj.put("template_name", Lela_util.nvl(rs.getString(1)+"-"+rs.getString(2), "пусто"));
