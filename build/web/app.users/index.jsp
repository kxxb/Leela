...
var tb = new Ext.Toolbar();
        ...
        <script type="text/javascript" src="app.users.frm.js"></script>
        <script type="text/javascript" src="app.users.tab.js"></script>
        <script type="text/javascript" src="app.users.deptree.js"></script>
        
        <script type="text/javascript" src="app.users.grid.js"></script>
        <script type="text/javascript" src="app.users.detailtab.js"></script>
