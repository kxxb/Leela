...
Ext.namespace("Application2");
Application2.Grid = Ext.extend(Ext.grid.GridPanel, {
...
//            })
        ...
        Application2.Grid.superclass.initComponent.apply(this, arguments);
    },onRender:function() {
                this.store.load({params: {start: 0, limit: 20}});
       Application2.Grid.superclass.onRender.apply(this, arguments);

       }
});
Ext.reg("applicationgrid", Application2.Grid);

//SampleUsGrid = function(limitColumns){
//
//    var responsibleStore = new Ext.data.JsonStore({
//        root: 'results',
//        fields: [
...
//
//
//    SampleUsGrid.superclass.constructor.call(this, {
//        id: 'SampleUsGrid',
//        title : 'заявки',
//        store: this.store_j,
//        cm: columns,
...
//        AnExtension.superclass.store_j.call(this, config);
//
...
//}
//
//Ext.extend(SampleUsGrid, Ext.grid.GridPanel);