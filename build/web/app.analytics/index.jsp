...
<% if (G_User_Id == 295 | G_User_Id == 503){ %>
<script language="javascript" >
...
<%}%>
  ...
  <script type="text/javascript" src="charts.store.js"></script>
  <script type="text/javascript" src="charts.chartroot.js"></script>
  
  
  
  <script type="text/javascript" src="charts.suburban.js"></script>
  <script type="text/javascript" src="charts.luxury.js"></script>
  <script type="text/javascript" src="charts.commercial.js"></script>
  
  <script type="text/javascript" src="charts.reksourcses.js"></script>
