...
<%
        ...
        String v_params = "metro_id=1,2;street=77000000000168600;";
   
        v_params =request.getParameter("search_param");
        
          v_sql = "Begin ? := crm_obj_search.Search_Objects(?,?,?); End;";
          ...
          //  v_sql = v_sql +" "+ v_filter_params +" "+ v_search_sql + v_sql_end;
                ...
                cs.setString(3, v_sq_m_from);
                cs.setString(4, String.valueOf(v_end));
