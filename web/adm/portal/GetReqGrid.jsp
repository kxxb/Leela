 ...
 String v_sql_ForMeRequests =  " /*мои заявки*/ "+
    ...
    if (request.getParameter("limit")==null) {
         ...
         if (!request.getParameter("CreateDtStart").equals("") & !request.getParameter("CreateDtFinish").equals("")
             ...
             v_filter_params = v_filter_params + " and dt_create between to_date('"
                     + request.getParameter("CreateDtStart") +"',  'dd.mm.yyyy') and to_date('"+request.getParameter("CreateDtFinish")+"',  'dd.mm.yyyy')";
         }
         ...
         if (//request.getParameter("DoneDtStart")!=null & request.getParameter("DoneDtFinish")!=null
             ...
             v_filter_params = v_filter_params + " and dt_execute between to_date('"
                     + request.getParameter("DoneDtStart") +"',  'dd.mm.yyyy') and to_date('"+request.getParameter("DoneDtFinish")+"',  'dd.mm.yyyy')";
         }
      ...
      if ( !request.getParameter("Aplicant").equals("")){
        ...
        /*end pager*/
             ...
             cs.setString(1, session.getAttribute("g_user_id").toString());
