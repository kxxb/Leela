<%-- 
    Document   : index.jsp
    Created on : 10.04.2012, 11:55:30
    Author     : kxxb
--%>
  ...
  <head>
    <title>Поиск объектов</title>
       ...
       <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script type="text/javascript" src="../app.search_objects/helper/mosmap.js"></script>    
...
<script language="javascript" >
  ...
  <!--Поиск объектов-->
  <script type="text/javascript" src="helper/app.search.root.js"></script>
  <script type="text/javascript" src="helper/app.search.grid.js"></script>
  <script type="text/javascript" src="helper/app.adress.pan.js"></script>
  <script type="text/javascript" src="helper/app.search.form.js"></script>
