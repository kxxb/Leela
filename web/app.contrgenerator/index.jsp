  ...
  <head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script type="text/javascript" src="../js/ext-3.2.1/ext-all-debug-w-comments.js"></script>
         <!-- extensions -->
         <script type="text/javascript" src="../js/ext-3.2.1/ux/CheckColumn.js"></script>
        ...
        <script type="text/javascript" src="app.stores.js"></script>
        <script type="text/javascript" src="app.grids.js"></script>
        
        <script type="text/javascript" src="app.layout.js"></script>
        <script type="text/javascript" src="app.frm.js"></script>
