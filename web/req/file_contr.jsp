...
<%
  ...
  /*cs = (OracleCallableStatement) conn.prepareCall("select t.doc_file as Blob_Data," +
                                                 "  c.template_name||substr(t.fl_name, instr(t.fl_name,'.',1), (length(t.fl_name)-instr(t.fl_name,'.',1)+1)) as Name " +
                                                 " from tl_contract_tpl_docs t, tl_contract_template c " +
                                                 " Where t.tl_contr_id  = :fileId " +
                                                 " and t.tl_contr_id = c.id" +
                                                 " and t.is_default = 1");
  */
  cs.setStringAtName("fileId", request.getParameter("file_id"));
  cs.execute();
